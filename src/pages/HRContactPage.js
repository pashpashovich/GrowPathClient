      ...
      <Box sx={{ maxWidth: 640, mx: 'auto' }}>
        ...
        >
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Если у вас ещё нет учётной записи в GrowPath, обратитесь в HR-отдел вашей организации. Специалисты
            помогут оформить доступ, назначить роль (стажёр, ментор, HR) и ответят на вопросы по программам
            стажировок.
          </Typography>
